...
import { MoreVertical, Plus, Trash2, Edit, CornerDownRight } from 'lucide-react';
        ...
        <div className="ml-auto flex items-center gap-1 opacity-0 transition-opacity group-hover:opacity-100">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onSelect={() => setShowAddSubtask(true)}>
          ...
          >
            <form onSubmit={handleAddSubtask} className="flex items-center gap-2 p-2">
              ...
              <Input
                ...
                className="h-8"
                onBlur={() => {if(!subtaskText) setShowAddSubtask(false)}}
